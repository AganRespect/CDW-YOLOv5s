...
def parse_opt():
    ...
    ###一般要修改的参数
    parser.add_argument("--data", type=str, default=ROOT /  "data/datayaml/yolov5_PinCompression.yaml", help="dataset.yaml path")
    parser.add_argument("--project", default=ROOT / "vals/PinNectVal", help="save to project/name")
    parser.add_argument("--name", default="0_yolov5s", help="save to project/name")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "weights/0_yolov5s.pt", help="model path(s)")
